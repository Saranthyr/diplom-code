...
export default function NewArticle() {
  ...
  // useEffect(() => {
  //   fetch("/regions").then(async (res) => {
  //     console.log(res);
  //     const regionsResponse = await res.json();
  //     console.log(regionsResponse);
  //     // setRegions(regionsResponse);
  //   });
  //   fetch("/tourism").then(async (res) => {
  //     // const tourismResponse = await res.json();
  //     // setTourism(tourismResponse);
  //   });
  // }, []);
